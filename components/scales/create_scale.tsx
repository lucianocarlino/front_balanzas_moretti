...
export default function Form( { packages, available_addresses }:  { packages: ResponsePackages[], available_addresses: number[] }) {
    ...
    return (
        <form action={createScale.bind(null)}>
            <div className="rounded-md bg-gray-100 p-4 md:p-6">
                <div className="mb-4">
                    <label className="mb-2 block text-l font-medium text-black" htmlFor="scale_id">Ingrese un identificador</label>
                ...
                <div className="mb-4">
                    <label htmlFor="packages" className="mb-2 block text-l text-black font-medium">Seleccione los paquetes (maximo {maxPackages})</label>
                    <div className="relative">
                        {packages.map((package_) => (
                            <div key={package_.package_id} className="flex items-center mb-2">
                                ...
                                />
                                <label htmlFor={`package_${package_.package_id}`} className="text-sm text-black">{package_.name}</label>
                            </div>
                        ))}
                    </div>
                    {
                ...
                <div className="mb-4">
                    <label htmlFor="addresses" className="mb-2 block text-l text-black font-medium">Seleccione una direccion</label>
                    <div className="relative">
                ...
                <div className="mb-4">
                    <div className="mt-6 flex justify-end gap-4">
                        ...
                        <Button type="submit" disabled={isDisabled}>Agregar balanza</Button>
                    </div>
                </div>
            </div>
        </form>
