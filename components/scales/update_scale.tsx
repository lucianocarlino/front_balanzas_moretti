...
export default function Form( { scale, packages }:  { scale: ResponseScales, packages: ResponsePackages[] }) {
    ...
    return (
        <form action={updateScale.bind(null, scale.scale_id)}>
            <div className="rounded-md bg-gray-100 p-4 md:p-6">
                ...
                <div className="mb-4">
                    <label htmlFor="packages" className="mb-2 block text-l text-black font-medium">Seleccione los paquetes</label>
                    <div className="relative">
                        {packages.map((package_) => (
                            <div key={package_.package_id} className="flex items-center mb-2">
                                <input 
                                    ...
                                    className="mr-2"
                                    defaultChecked={scale.packages.map(p => p.package_id).includes(package_.package_id)}
